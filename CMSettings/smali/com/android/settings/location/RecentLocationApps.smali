.class public Lcom/cyanogenmod/settings/location/RecentLocationApps;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cyanogenmod/settings/location/RecentLocationApps$PackageEntryClickedListener;
    }
.end annotation
...
# instance fields
.field private final mActivity:Lcom/cyanogenmod/settings/SettingsActivity;

.field private final mPackageManager:Landroid/content/pm/PackageManager;


# direct methods
.method static synthetic -get0(Lcom/cyanogenmod/settings/location/RecentLocationApps;)Lcom/cyanogenmod/settings/SettingsActivity;
    .locals 1

    iget-object v0, p0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/cyanogenmod/settings/SettingsActivity;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 47
    const-class v0, Lcom/cyanogenmod/settings/location/RecentLocationApps;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->TAG:Ljava/lang/String;

    .line 46
    return-void
.end method

.method public constructor <init>(Lcom/cyanogenmod/settings/SettingsActivity;)V
    .locals 1
    .param p1, "activity"    # Lcom/cyanogenmod/settings/SettingsActivity;
    ...
    .line 56
    iput-object p1, p0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/cyanogenmod/settings/SettingsActivity;

    .line 57
    invoke-virtual {p1}, Lcom/cyanogenmod/settings/SettingsActivity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iput-object v0, p0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 55
    return-void
.end method

.method private createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/cyanogenmod/settings/DimmableIconPreference;
    .locals 2
    ...
    .prologue
    .line 87
    new-instance v0, Lcom/cyanogenmod/settings/DimmableIconPreference;

    iget-object v1, p0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/cyanogenmod/settings/SettingsActivity;

    invoke-direct {v0, v1, p4}, Lcom/cyanogenmod/settings/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    .line 88
    .local v0, "pref":Lcom/cyanogenmod/settings/DimmableIconPreference;
    invoke-virtual {v0, p1}, Lcom/cyanogenmod/settings/DimmableIconPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 89
    invoke-virtual {v0, p2}, Lcom/cyanogenmod/settings/DimmableIconPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/DimmableIconPreference;->setSummary(I)V

    .line 95
    :goto_0
    invoke-virtual {v0, p5}, Lcom/cyanogenmod/settings/DimmableIconPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
...
.method private getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
    ...
    .line 182
    .local v19, "preference":Lcom/cyanogenmod/settings/DimmableIconPreference;
    :try_start_0
    ...
    .line 186
    sget-object v4, Lcom/cyanogenmod/settings/location/RecentLocationApps;->TAG:Ljava/lang/String;
    ...
    .end local v19    # "preference":Lcom/cyanogenmod/settings/DimmableIconPreference;
    .end local v23    # "uid":I
    ...
    .restart local v19    # "preference":Lcom/cyanogenmod/settings/DimmableIconPreference;
    ...
    iget-object v4, v0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/cyanogenmod/settings/SettingsActivity;

    invoke-virtual {v4}, Lcom/cyanogenmod/settings/SettingsActivity;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v4, v0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    :cond_7
    new-instance v9, Lcom/cyanogenmod/settings/location/RecentLocationApps$PackageEntryClickedListener;
    ...
    invoke-direct {v9, v0, v1, v2}, Lcom/cyanogenmod/settings/location/RecentLocationApps$PackageEntryClickedListener;-><init>(Lcom/cyanogenmod/settings/location/RecentLocationApps;Ljava/lang/String;Landroid/os/UserHandle;)V

    move-object/from16 v4, p0

    .line 202
    invoke-direct/range {v4 .. v9}, Lcom/cyanogenmod/settings/location/RecentLocationApps;->createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lcom/cyanogenmod/settings/DimmableIconPreference;
    :try_end_1
...
.method public getAppList()Ljava/util/List;
    ...
    iget-object v0, v0, Lcom/cyanogenmod/settings/location/RecentLocationApps;->mActivity:Lcom/cyanogenmod/settings/SettingsActivity;

    move-object/from16 v17, v0

    const-string/jumbo v18, "appops"

    invoke-virtual/range {v17 .. v18}, Lcom/cyanogenmod/settings/SettingsActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v15, v8, v9, v7}, Lcom/cyanogenmod/settings/location/RecentLocationApps;->getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;

.class Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/cyanogenmod/settings/search/Index;
.end annotation
...
# instance fields
.field final synthetic this$0:Lcom/cyanogenmod/settings/search/Index;


# direct methods
.method private constructor <init>(Lcom/cyanogenmod/settings/search/Index;)V
    .locals 0
    .param p1, "this$0"    # Lcom/cyanogenmod/settings/search/Index;

    .prologue
    .line 1171
    iput-object p1, p0, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->this$0:Lcom/cyanogenmod/settings/search/Index;
...
.method synthetic constructor <init>(Lcom/cyanogenmod/settings/search/Index;Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;)V
    .locals 0
    .param p1, "this$0"    # Lcom/cyanogenmod/settings/search/Index;

    .prologue
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;-><init>(Lcom/cyanogenmod/settings/search/Index;)V
...
.method private processDataToDelete(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-direct {v0, v1, v11, v12}, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->delete(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;)I

    goto :goto_1

    .line 1273
    :cond_2
    instance-of v11, v3, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;
    ...
    .line 1274
    check-cast v7, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;

    .line 1275
    .local v7, "raw":Lcom/cyanogenmod/settings/search/SearchIndexableRaw;
    iget-object v11, v7, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;
    ...
    iget-object v12, v7, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;
    ...
    .end local v7    # "raw":Lcom/cyanogenmod/settings/search/SearchIndexableRaw;
    :cond_3
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
...
.method private processDataToUpdate(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Z)Z
    ...
    invoke-direct/range {p0 .. p2}, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->isLocaleAlreadyIndexed(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    iget-object v13, v0, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->this$0:Lcom/cyanogenmod/settings/search/Index;
    ...
    invoke-static {v13, v0, v1, v5, v2}, Lcom/cyanogenmod/settings/search/Index;->-wrap1(Lcom/cyanogenmod/settings/search/Index;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/provider/SearchIndexableData;Ljava/util/Map;)V
    :try_end_0
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .prologue
    .line 1186
    check-cast p1, [Lcom/cyanogenmod/settings/search/Index$UpdateData;

    .end local p1    # "params":[Ljava/lang/Object;
    invoke-virtual {p0, p1}, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->doInBackground([Lcom/cyanogenmod/settings/search/Index$UpdateData;)Ljava/lang/Void;
...
.method protected varargs doInBackground([Lcom/cyanogenmod/settings/search/Index$UpdateData;)Ljava/lang/Void;
    .locals 12
    .param p1, "params"    # [Lcom/cyanogenmod/settings/search/Index$UpdateData;
    ...
    iget-object v3, v0, Lcom/cyanogenmod/settings/search/Index$UpdateData;->dataToUpdate:Ljava/util/List;

    .line 1188
    .local v3, "dataToUpdate":Ljava/util/List;, "Ljava/util/List<Landroid/provider/SearchIndexableData;>;"
    aget-object v0, p1, v9

    iget-object v6, v0, Lcom/cyanogenmod/settings/search/Index$UpdateData;->dataToDelete:Ljava/util/List;

    .line 1189
    .local v6, "dataToDelete":Ljava/util/List;, "Ljava/util/List<Landroid/provider/SearchIndexableData;>;"
    aget-object v0, p1, v9

    iget-object v4, v0, Lcom/cyanogenmod/settings/search/Index$UpdateData;->nonIndexableKeys:Ljava/util/Map;

    .line 1191
    .local v4, "nonIndexableKeys":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/String;>;>;"
    aget-object v0, p1, v9

    iget-boolean v5, v0, Lcom/cyanogenmod/settings/search/Index$UpdateData;->forceUpdate:Z
    ...
    :try_start_0
    iget-object v0, p0, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->this$0:Lcom/cyanogenmod/settings/search/Index;

    invoke-static {v0}, Lcom/cyanogenmod/settings/search/Index;->-wrap0(Lcom/cyanogenmod/settings/search/Index;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 1204
    invoke-direct {p0, v1, v2, v6}, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->processDataToDelete(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/util/List;)Z
    ...
    .line 1207
    invoke-direct/range {v0 .. v5}, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->processDataToUpdate(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Z)Z
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/cyanogenmod/settings/search/Index$UpdateIndexTask;->onPostExecute(Ljava/lang/Void;)V
...
.method protected onPostExecute(Ljava/lang/Void;)V
    ...
    invoke-static {v0}, Lcom/cyanogenmod/settings/search/Index;->-get1(Lcom/cyanogenmod/settings/search/Index;)Ljava/util/concurrent/atomic/AtomicBoolean;

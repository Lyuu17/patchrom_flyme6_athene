.class public Lcom/cyanogenmod/settings/DeviceAdminAdd;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgEllipsized:Z
...
.method private addDeviceAdminPolicies(Z)V
    ...
    .line 474
    iget-boolean v6, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminPoliciesInitialized:Z
    ...
    .line 476
    .local v1, "isOwner":Z
    iget-object v6, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;
    ...
    .local v2, "labelId":I
    :goto_2
    invoke-virtual {p0, v2}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getText(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getText(I)Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminPolicies:Landroid/view/ViewGroup;
    ...
    :cond_3
    iput-boolean v8, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminPoliciesInitialized:Z
...
.method addAndFinish()V
    ...
    .line 328
    :try_start_0
    iget-object v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDPM:Landroid/app/admin/DevicePolicyManager;

    iget-object v3, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;

    invoke-virtual {v3}, Landroid/app/admin/DeviceAdminInfo;->getComponent()Landroid/content/ComponentName;

    move-result-object v3

    iget-boolean v4, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mRefreshing:Z

    invoke-virtual {v2, v3, v4}, Landroid/app/admin/DevicePolicyManager;->setActiveAdmin(Landroid/content/ComponentName;Z)V

    .line 330
    iget-object v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;
    ...
    invoke-virtual {p0, v2}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->setResult(I)V
    :try_end_0
    ...
    :cond_0
    :goto_0
    iget-boolean v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddingProfileOwner:Z
    ...
    .line 344
    iget-object v4, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mProfileOwnerName:Ljava/lang/String;
    ...
    :cond_1
    :goto_1
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->finish()V
    ...
    .line 336
    iget-object v4, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;
    ...
    .line 338
    invoke-virtual {p0, v5}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->setResult(I)V
...
.method continueRemoveAction(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 353
    iget-boolean v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mWaitingForRemoveMsg:Z
    ...
    iput-boolean v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mWaitingForRemoveMsg:Z
    ...
    invoke-virtual {p0, v2, v0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->showDialog(ILandroid/os/Bundle;)Z
...
.method getEllipsizedLines()I
    ...
    invoke-virtual {p0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getMainLooper()Landroid/os/Looper;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAppOps:Landroid/app/AppOpsManager;

    .line 108
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v18

    .line 110
    .local v18, "packageManager":Landroid/content/pm/PackageManager;
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getIntent()Landroid/content/Intent;
    ...
    .line 112
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->finish()V
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->setResult(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->setFinishOnTouchOutside(Z)V
    ...
    iput-boolean v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddingProfileOwner:Z
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mProfileOwnerName:Ljava/lang/String;

    .line 131
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getCallingPackage()Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;
    :try_end_3
    ...
    iput-boolean v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mRefreshing:Z
    ...
    iget-object v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;
    ...
    iget-boolean v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mRefreshing:Z
    ...
    iget-boolean v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddingProfileOwner:Z
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgText:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->setContentView(I)V

    .line 242
    const v22, 0x7f1300b4

    move-object/from16 v0, p0

    move/from16 v1, v22

    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->findViewById(I)Landroid/view/View;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminIcon:Landroid/widget/ImageView;

    .line 243
    const v22, 0x7f1300b5
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminName:Landroid/widget/TextView;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminDescription:Landroid/widget/TextView;

    .line 245
    const v22, 0x7f1300b6
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mProfileOwnerWarning:Landroid/widget/TextView;

    .line 247
    const v22, 0x7f1300b9
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsg:Landroid/widget/TextView;

    .line 248
    const v22, 0x7f1300b8
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgExpander:Landroid/widget/ImageView;

    .line 249
    new-instance v16, Lcom/cyanogenmod/settings/DeviceAdminAdd$1;

    move-object/from16 v0, v16

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd$1;-><init>(Lcom/cyanogenmod/settings/DeviceAdminAdd;)V

    .line 255
    .local v16, "onClickListener":Landroid/view/View$OnClickListener;
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgExpander:Landroid/widget/ImageView;
    ...
    iget-object v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsg:Landroid/widget/TextView;
    ...
    .line 261
    new-instance v23, Lcom/cyanogenmod/settings/DeviceAdminAdd$2;

    move-object/from16 v0, v23

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd$2;-><init>(Lcom/cyanogenmod/settings/DeviceAdminAdd;)V
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminWarning:Landroid/widget/TextView;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminPolicies:Landroid/view/ViewGroup;

    .line 281
    const v22, 0x7f13004f
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mCancelButton:Landroid/widget/Button;

    .line 282
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mCancelButton:Landroid/widget/Button;
    ...
    new-instance v23, Lcom/cyanogenmod/settings/DeviceAdminAdd$3;

    move-object/from16 v0, v23

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd$3;-><init>(Lcom/cyanogenmod/settings/DeviceAdminAdd;)V
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mActionButton:Landroid/widget/Button;

    .line 291
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mActionButton:Landroid/widget/Button;
    ...
    new-instance v23, Lcom/cyanogenmod/settings/DeviceAdminAdd$4;

    move-object/from16 v0, v23

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd$4;-><init>(Lcom/cyanogenmod/settings/DeviceAdminAdd;)V
    ...
    :cond_c
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->addAndFinish()V
...
.method protected onCreateDialog(ILandroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 412
    new-instance v2, Lcom/cyanogenmod/settings/DeviceAdminAdd$5;

    invoke-direct {v2, p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd$5;-><init>(Lcom/cyanogenmod/settings/DeviceAdminAdd;)V
...
.method protected onPause()V
    ...
    iget-object v3, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAppOps:Landroid/app/AppOpsManager;

    iget v4, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mCurSysAppOpMode:I
    ...
    iget v4, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mCurToastAppOpMode:I
...
.method protected onResume()V
    ...
    .line 380
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->updateInterface()V
    ...
    iget-object v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAppOps:Landroid/app/AppOpsManager;

    invoke-virtual {v2, v4, v1, v0}, Landroid/app/AppOpsManager;->checkOp(IILjava/lang/String;)I

    move-result v2

    iput v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mCurSysAppOpMode:I
    ...
    iput v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mCurToastAppOpMode:I
...
.method toggleMessageEllipsis(Landroid/view/View;)V
    ...
    iget-boolean v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgEllipsized:Z
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgEllipsized:Z
    ...
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getEllipsizedLines()I
    ...
    .line 494
    iget-object v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgExpander:Landroid/widget/ImageView;
...
.method updateInterface()V
    ...
    .line 432
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminIcon:Landroid/widget/ImageView;

    iget-object v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDeviceAdmin:Landroid/app/admin/DeviceAdminInfo;

    invoke-virtual {p0}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    .line 433
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminName:Landroid/widget/TextView;
    ...
    .line 435
    :try_start_0
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminDescription:Landroid/widget/TextView;
    ...
    .line 441
    :goto_0
    iget-boolean v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddingProfileOwner:Z

    if-eqz v1, :cond_0

    .line 442
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mProfileOwnerWarning:Landroid/widget/TextView;

    invoke-virtual {v1, v5}, Landroid/widget/TextView;->setVisibility(I)V

    .line 444
    :cond_0
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgText:Ljava/lang/CharSequence;

    if-eqz v1, :cond_2

    .line 445
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsg:Landroid/widget/TextView;

    iget-object v2, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgText:Ljava/lang/CharSequence;
    ...
    .line 451
    :goto_1
    iget-boolean v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mRefreshing:Z
    ...
    .line 460
    :cond_1
    invoke-direct {p0, v6}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->addDeviceAdminPolicies(Z)V

    .line 461
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdminWarning:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v3, v2}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->setTitle(Ljava/lang/CharSequence;)V

    .line 468
    :goto_2
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mActionButton:Landroid/widget/Button;
    ...
    .line 469
    iput-boolean v6, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdding:Z
    ...
    .line 449
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAddMsgExpander:Landroid/widget/ImageView;
    ...
    .line 452
    :cond_3
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    .line 453
    invoke-direct {p0, v5}, Lcom/cyanogenmod/settings/DeviceAdminAdd;->addDeviceAdminPolicies(Z)V
    ...
    .line 458
    iput-boolean v5, p0, Lcom/cyanogenmod/settings/DeviceAdminAdd;->mAdding:Z

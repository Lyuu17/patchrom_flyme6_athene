.class final Lcom/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences;
...
.method static synthetic -wrap0(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    .prologue
    invoke-static {p0}, Lcom/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences;->getSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method static persistDiscoveringTimestamp(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences$1;

    invoke-direct {v1, p0}, Lcom/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences$1;-><init>(Landroid/content/Context;)V
...
.method static shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .prologue
    .line 67
    invoke-static/range {p0 .. p0}, Lcom/cyanogenmod/settings/bluetooth/Utils;->getLocalBtManager(Landroid/content/Context;)Lcom/cyanogenmod/settingslib/bluetooth/LocalBluetoothManager;

    move-result-object v10

    .line 68
    .local v10, "manager":Lcom/cyanogenmod/settingslib/bluetooth/LocalBluetoothManager;
    if-nez v10, :cond_0
    ...
    .line 74
    :cond_0
    invoke-virtual {v10}, Lcom/cyanogenmod/settingslib/bluetooth/LocalBluetoothManager;->isForegroundActivity()Z
    ...
    invoke-static/range {p0 .. p0}, Lcom/cyanogenmod/settings/bluetooth/LocalBluetoothPreferences;->getSharedPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    .line 97
    :cond_3
    invoke-virtual {v10}, Lcom/cyanogenmod/settingslib/bluetooth/LocalBluetoothManager;->getBluetoothAdapter()Lcom/cyanogenmod/settingslib/bluetooth/LocalBluetoothAdapter;

    move-result-object v2

    .line 98
    .local v2, "adapter":Lcom/cyanogenmod/settingslib/bluetooth/LocalBluetoothAdapter;
    if-eqz v2, :cond_4

    invoke-virtual {v2}, Lcom/cyanogenmod/settingslib/bluetooth/LocalBluetoothAdapter;->isDiscovering()Z

.class public Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
    ...
    .line 43
    iput-object v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    .prologue
    .line 138
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->getPreferenceManager()Landroid/preference/PreferenceManager;

    move-result-object v4

    invoke-virtual {p0}, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->getActivity()Landroid/app/Activity;
    ...
    iget-object v5, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;
    ...
    .line 146
    iget-object v7, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private updateCheckedState()V
    ...
    .line 152
    iget-object v3, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    .line 153
    iget-object v4, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    .line 156
    iget-object v3, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;

    .line 63
    iget-object v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    invoke-virtual {p0, v0}, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/hardware/input/InputManager;

    iput-object v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    .line 68
    iget-object v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    invoke-virtual {v0}, Landroid/hardware/input/InputManager;->getKeyboardLayouts()[Landroid/hardware/input/KeyboardLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;

    .line 69
    iget-object v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;

    invoke-static {v0}, Ljava/util/Arrays;->sort([Ljava/lang/Object;)V

    .line 70
    invoke-direct {p0}, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->createPreferenceHierarchy()Landroid/preference/PreferenceScreen;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
...
.method public onInputDeviceChanged(I)V
    ...
    .prologue
    .line 125
    iget v0, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
    ...
    .line 126
    invoke-direct {p0}, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->updateCheckedState()V
...
.method public onResume()V
    ...
    .line 77
    iget-object v1, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;
    ...
    iget-object v2, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceIdentifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    iput v1, p0, Lcom/cyanogenmod/settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I

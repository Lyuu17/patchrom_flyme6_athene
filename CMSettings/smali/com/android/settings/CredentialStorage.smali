.class public final Lcom/cyanogenmod/settings/CredentialStorage;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cyanogenmod/settings/CredentialStorage$ResetDialog;,
        Lcom/cyanogenmod/settings/CredentialStorage$ResetKeyStoreAndKeyChain;,
        Lcom/cyanogenmod/settings/CredentialStorage$ConfigureKeyGuardDialog;,
        Lcom/cyanogenmod/settings/CredentialStorage$UnlockDialog;
    }
.end annotation
...
.method static synthetic -get0()[I
    ...
    sget-object v0, Lcom/cyanogenmod/settings/CredentialStorage;->SYSTEM_CREDENTIAL_UIDS:[I

    return-object v0
.end method

.method static synthetic -get1(Lcom/cyanogenmod/settings/CredentialStorage;)Landroid/security/KeyStore;
    .locals 1

    iget-object v0, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;

    return-object v0
.end method

.method static synthetic -get2(Lcom/cyanogenmod/settings/CredentialStorage;)I
    .locals 1

    iget v0, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mRetriesRemaining:I
...
.method private static synthetic -getandroid_security_KeyStore$StateSwitchesValues()[I
    ...
    sget-object v0, Lcom/cyanogenmod/settings/CredentialStorage;->-android_security_KeyStore$StateSwitchesValues:[I
    ...
    :goto_2
    sput-object v0, Lcom/cyanogenmod/settings/CredentialStorage;->-android_security_KeyStore$StateSwitchesValues:[I
...
.method static synthetic -set0(Lcom/cyanogenmod/settings/CredentialStorage;I)I
    .locals 0

    iput p1, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mRetriesRemaining:I

    return p1
.end method

.method static synthetic -wrap0(Lcom/cyanogenmod/settings/CredentialStorage;)V
    .locals 0

    invoke-direct {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->ensureKeyGuard()V

    return-void
.end method

.method static synthetic -wrap1(Lcom/cyanogenmod/settings/CredentialStorage;)V
    .locals 0

    invoke-direct {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->handleUnlockOrInstall()V
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/cyanogenmod/settings/CredentialStorage;->SYSTEM_CREDENTIAL_UIDS:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;

    .line 125
    const/4 v0, -0x1

    iput v0, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mRetriesRemaining:I
...
.method private checkCallerIsCertInstallerOrSelfInProfile()Z
    ...
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->getCallingPackage()Ljava/lang/String;
    ...
    .line 423
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->getPackageName()Ljava/lang/String;
    ...
    .line 430
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->getActivityToken()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v7}, Lcom/cyanogenmod/settings/CredentialStorage;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private confirmKeyGuard()Z
    ...
    .line 458
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->getResources()Landroid/content/res/Resources;
    ...
    invoke-direct {v2, p0}, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;-><init>(Landroid/app/Activity;)V
    ...
    .line 459
    invoke-virtual {v2, v4, v3, v4}, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Z)Z
...
.method private ensureKeyGuard()V
    ...
    .prologue
    .line 192
    invoke-direct {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->checkKeyGuardQuality()Z
    ...
    .line 194
    new-instance v0, Lcom/cyanogenmod/settings/CredentialStorage$ConfigureKeyGuardDialog;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/cyanogenmod/settings/CredentialStorage$ConfigureKeyGuardDialog;-><init>(Lcom/cyanogenmod/settings/CredentialStorage;Lcom/cyanogenmod/settings/CredentialStorage$ConfigureKeyGuardDialog;)V
    ...
    .line 199
    :cond_0
    invoke-direct {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->confirmKeyGuard()Z
    ...
    .line 203
    :cond_1
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->finish()V
...
.method private handleUnlockOrInstall()V
    ...
    .line 161
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->isFinishing()Z
    ...
    .line 164
    :cond_0
    invoke-static {}, Lcom/cyanogenmod/settings/CredentialStorage;->-getandroid_security_KeyStore$StateSwitchesValues()[I

    move-result-object v0

    iget-object v1, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;
    ...
    .line 170
    :pswitch_1
    new-instance v0, Lcom/cyanogenmod/settings/CredentialStorage$UnlockDialog;

    invoke-direct {v0, p0, v2}, Lcom/cyanogenmod/settings/CredentialStorage$UnlockDialog;-><init>(Lcom/cyanogenmod/settings/CredentialStorage;Lcom/cyanogenmod/settings/CredentialStorage$UnlockDialog;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/cyanogenmod/settings/CredentialStorage$ConfigureKeyGuardDialog;-><init>(Lcom/cyanogenmod/settings/CredentialStorage;Lcom/cyanogenmod/settings/CredentialStorage$ConfigureKeyGuardDialog;)V
    ...
    .line 178
    :cond_1
    invoke-direct {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->installIfAvailable()V
...
.method private installIfAvailable()V
    ...
    .prologue
    .line 234
    iget-object v12, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;
    ...
    .line 238
    :cond_1
    iget-object v0, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;

    .line 239
    .local v0, "bundle":Landroid/os/Bundle;
    const/4 v12, 0x0

    iput-object v12, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;
    ...
    invoke-direct {p0, v11}, Lcom/cyanogenmod/settings/CredentialStorage;->isHardwareBackedKey([B)Z
    ...
    .line 273
    :cond_3
    iget-object v12, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;
    ...
    invoke-virtual {p0, v7, v12}, Lcom/cyanogenmod/settings/CredentialStorage;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    invoke-virtual {p0, v12}, Lcom/cyanogenmod/settings/CredentialStorage;->setResult(I)V
...
.method protected onResume()V
    ...
    .line 131
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v3}, Lcom/cyanogenmod/settings/CredentialStorage;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 136
    new-instance v3, Lcom/cyanogenmod/settings/CredentialStorage$ResetDialog;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lcom/cyanogenmod/settings/CredentialStorage$ResetDialog;-><init>(Lcom/cyanogenmod/settings/CredentialStorage;Lcom/cyanogenmod/settings/CredentialStorage$ResetDialog;)V
    ...
    invoke-direct {p0}, Lcom/cyanogenmod/settings/CredentialStorage;->checkCallerIsCertInstallerOrSelfInProfile()Z
    ...
    iput-object v3, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;
    ...
    iget-object v3, p0, Lcom/cyanogenmod/settings/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;

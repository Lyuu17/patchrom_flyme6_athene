.class public Lcom/cyanogenmod/settings/CreateShortcut;
...
.method private getDrawableResource(I)I
    ...
    .line 92
    .local v0, "categories":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/cyanogenmod/settings/dashboard/DashboardCategory;>;"
    const v5, 0x7f080019

    invoke-static {v5, v0, p0}, Lcom/cyanogenmod/settings/SettingsActivity;->loadCategoriesFromResource(ILjava/util/List;Landroid/content/Context;)V
    ...
    check-cast v1, Lcom/cyanogenmod/settings/dashboard/DashboardCategory;

    .line 94
    .local v1, "category":Lcom/cyanogenmod/settings/dashboard/DashboardCategory;
    iget-object v5, v1, Lcom/cyanogenmod/settings/dashboard/DashboardCategory;->tiles:Ljava/util/List;
    ...
    check-cast v3, Lcom/cyanogenmod/settings/dashboard/DashboardTile;

    .line 95
    .local v3, "tile":Lcom/cyanogenmod/settings/dashboard/DashboardTile;
    iget-wide v6, v3, Lcom/cyanogenmod/settings/dashboard/DashboardTile;->id:J
    ...
    .line 96
    iget v5, v3, Lcom/cyanogenmod/settings/dashboard/DashboardTile;->iconRes:I

    return v5

    .line 100
    .end local v1    # "category":Lcom/cyanogenmod/settings/dashboard/DashboardCategory;
    .end local v3    # "tile":Lcom/cyanogenmod/settings/dashboard/DashboardTile;
...
.method protected onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 57
    invoke-virtual {p0, p3}, Lcom/cyanogenmod/settings/CreateShortcut;->intentForPosition(I)Landroid/content/Intent;
    ...
    invoke-virtual {p0, p3}, Lcom/cyanogenmod/settings/CreateShortcut;->itemForPosition(I)Landroid/app/LauncherActivity$ListItem;
    ...
    invoke-direct {p0, v5}, Lcom/cyanogenmod/settings/CreateShortcut;->getDrawableResource(I)I
    ...
    invoke-direct {p0, v3}, Lcom/cyanogenmod/settings/CreateShortcut;->createIcon(I)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v6, v1}, Lcom/cyanogenmod/settings/CreateShortcut;->setResult(ILandroid/content/Intent;)V

    .line 72
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CreateShortcut;->finish()V
...
.method protected onQueryPackageManager(Landroid/content/Intent;)Ljava/util/List;
    ...
    .line 113
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/CreateShortcut;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    const-class v4, Lcom/cyanogenmod/settings/Settings$TetherSettingsActivity;
    ...
    .line 119
    invoke-static {p0}, Lcom/cyanogenmod/settingslib/TetherUtil;->isTetheringSupported(Landroid/content/Context;)Z

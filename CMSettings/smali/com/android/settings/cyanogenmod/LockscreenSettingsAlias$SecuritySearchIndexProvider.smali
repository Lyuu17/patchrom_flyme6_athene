.class Lcom/cyanogenmod/settings/cyanogenmod/LockscreenSettingsAlias$SecuritySearchIndexProvider;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/cyanogenmod/settings/cyanogenmod/LockscreenSettingsAlias;
.end annotation
...
.method public constructor <init>()V
    ...
    .line 49
    invoke-static {}, Lcom/cyanogenmod/settings/cyanogenmod/LockscreenSettingsAlias;->-get0()I
    ...
    :cond_0
    iput-boolean v0, p0, Lcom/cyanogenmod/settings/cyanogenmod/LockscreenSettingsAlias$SecuritySearchIndexProvider;->mIsPrimary:Z
...
.method public getRawDataToIndex(Landroid/content/Context;Z)Ljava/util/List;
    ...
    .line 72
    .local v9, "result":Ljava/util/List;, "Ljava/util/List<Lcom/cyanogenmod/settings/search/SearchIndexableRaw;>;"
    ...
    new-instance v2, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;

    invoke-direct {v2, p1}, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;-><init>(Landroid/content/Context;)V

    .line 77
    .local v2, "data":Lcom/cyanogenmod/settings/search/SearchIndexableRaw;
    iput-object v10, v2, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;

    .line 78
    iput-object v10, v2, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;->screenTitle:Ljava/lang/String;

    .line 79
    invoke-interface {v9, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 81
    iget-boolean v11, p0, Lcom/cyanogenmod/settings/cyanogenmod/LockscreenSettingsAlias$SecuritySearchIndexProvider;->mIsPrimary:Z
    ...
    .end local v2    # "data":Lcom/cyanogenmod/settings/search/SearchIndexableRaw;
    invoke-direct {v2, p1}, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;-><init>(Landroid/content/Context;)V

    .line 86
    .restart local v2    # "data":Lcom/cyanogenmod/settings/search/SearchIndexableRaw;
    invoke-virtual {v7, v8}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v11

    iput-object v11, v2, Lcom/cyanogenmod/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;
    ...
    .line 119
    invoke-static {v12, v5, v11}, Lcom/cyanogenmod/settings/cyanogenmod/LockscreenSettingsAlias;->-wrap1(Landroid/content/pm/PackageManager;Lcom/android/internal/widget/LockPatternUtils;Landroid/app/admin/DevicePolicyManager;)Ljava/util/ArrayList;
    ...
    .line 124
    .restart local v2    # "data":Lcom/cyanogenmod/settings/search/SearchIndexableRaw;
    iget-object v11, v0, Lcom/cyanogenmod/settings/TrustAgentUtils$TrustAgentComponentInfo;->title:Ljava/lang/String;
    ...
    .end local v1    # "agents":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/cyanogenmod/settings/TrustAgentUtils$TrustAgentComponentInfo;>;"
...
.method public getXmlResourcesToIndex(Landroid/content/Context;Z)Ljava/util/List;
    ...
    invoke-static {p1, v0}, Lcom/cyanogenmod/settings/cyanogenmod/LockscreenSettingsAlias;->-wrap0(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)I

.class public Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$WpsFragment;,
        Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$1;
    }
.end annotation
...
.field private mWifiAssistantPreference:Lcom/cyanogenmod/settings/AppListSwitchPreference;
...
# direct methods
.method static synthetic -get0(Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;)Landroid/preference/Preference;
    .locals 1

    iget-object v0, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWpsPinPref:Landroid/preference/Preference;

    return-object v0
.end method

.method static synthetic -get1(Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;)Landroid/preference/Preference;
    .locals 1

    iget-object v0, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWpsPushPref:Landroid/preference/Preference;

    return-object v0
.end method

.method static synthetic -wrap0(Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;)V
    .locals 0

    invoke-direct {p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->refreshWifiInfo()V
...
.method public constructor <init>()V
    ...
    .line 77
    new-instance v0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$1;

    invoke-direct {v0, p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$1;-><init>(Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;)V

    iput-object v0, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method private initPreferences()V
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    iget-object v0, v0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 144
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getActivity()Landroid/app/Activity;
    ...
    check-cast v17, Lcom/cyanogenmod/settings/AppListSwitchPreference;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiAssistantPreference:Lcom/cyanogenmod/settings/AppListSwitchPreference;
    ...
    iget-object v0, v0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiAssistantPreference:Lcom/cyanogenmod/settings/AppListSwitchPreference;
    ...
    .line 152
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 156
    const-class v17, Lcom/cyanogenmod/settings/Settings$WifiP2pSettingsActivity;
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWpsPushPref:Landroid/preference/Preference;

    .line 163
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWpsPushPref:Landroid/preference/Preference;

    move-object/from16 v17, v0

    new-instance v18, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$2;

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$2;-><init>(Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;)V
    ...
    iput-object v0, v1, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWpsPinPref:Landroid/preference/Preference;

    .line 174
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWpsPinPref:Landroid/preference/Preference;

    move-object/from16 v17, v0

    new-instance v18, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$3;

    move-object/from16 v0, v18

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings$3;-><init>(Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;)V
    ...
    invoke-direct {v0, v4, v12}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    ...
    .line 203
    invoke-virtual/range {p0 .. p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->removePreference(Ljava/lang/String;)V
    ...
    .line 220
    invoke-static {v3}, Lcom/cyanogenmod/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z
    ...
    invoke-direct {v0, v10, v11}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/cyanogenmod/settings/AppListSwitchPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 150
    move-object/from16 v0, p0

    invoke-direct {v0, v9}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->initWifiAssistantPreference(Ljava/util/Collection;)V
...
.method private initWifiAssistantPreference(Ljava/util/Collection;)V
    ...
    :cond_0
    iget-object v5, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiAssistantPreference:Lcom/cyanogenmod/settings/AppListSwitchPreference;

    .line 242
    iget-object v6, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mNetworkScoreManager:Landroid/net/NetworkScoreManager;
    ...
    .line 241
    invoke-virtual {v5, v2, v6}, Lcom/cyanogenmod/settings/AppListSwitchPreference;->setPackageNames([Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V
...
.method private refreshWifiInfo()V
    ...
    .line 354
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getActivity()Landroid/app/Activity;

    move-result-object v0

    .line 355
    .local v0, "context":Landroid/content/Context;
    iget-object v6, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {p0, v6}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-static {v0}, Lcom/cyanogenmod/settings/Utils;->getWifiIpAddresses(Landroid/content/Context;)Ljava/lang/String;
...
.method private updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    ...
    .prologue
    .line 266
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getResources()Landroid/content/res/Resources;
...
.method private updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/cyanogenmod/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/net/wifi/WifiManager;

    iput-object v0, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mFilter:Landroid/content/IntentFilter;

    .line 109
    iget-object v0, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mFilter:Landroid/content/IntentFilter;
    ...
    .line 112
    iput-object v0, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mNetworkScoreManager:Landroid/net/NetworkScoreManager;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->addPreferencesFromResource(I)V
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 292
    .local v7, "value":I
    iget-object v9, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    .line 293
    invoke-direct {p0, p1, v7}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->updateFrequencyBandSummary(Landroid/preference/Preference;I)V
    :try_end_0
    ...
    .line 329
    :try_start_1
    iget-object v10, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 342
    invoke-direct {p0, p1, v6}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->updateSleepPolicySummary(Landroid/preference/Preference;Ljava/lang/String;)V
    :try_end_2
    ...
    .line 303
    iget-object v9, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mNetworkScoreManager:Landroid/net/NetworkScoreManager;
    ...
    .line 321
    :goto_0
    invoke-virtual {p0, v4}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->startActivity(Landroid/content/Intent;)V
...
.method public onResume()V
    ...
    .line 119
    invoke-direct {p0}, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->initPreferences()V
    ...
    iget-object v2, p0, Lcom/cyanogenmod/settings/wifi/AdvancedWifiSettings;->mFilter:Landroid/content/IntentFilter;

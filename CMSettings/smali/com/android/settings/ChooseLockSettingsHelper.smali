.class public final Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    .line 46
    iput-object p1, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mActivity:Landroid/app/Activity;
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mCmLockPatternUtils:Lorg/cyanogenmod/internal/util/CmLockPatternUtils;
...
.method public constructor <init>(Landroid/app/Activity;Landroid/app/Fragment;)V
    ...
    .prologue
    .line 52
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;-><init>(Landroid/app/Activity;)V

    .line 53
    iput-object p2, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mFragment:Landroid/app/Fragment;
...
.method private launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Class;ZZJ)Z
    ...
    .line 171
    iget-object v1, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mFragment:Landroid/app/Fragment;
    ...
    .line 174
    :cond_0
    iget-object v1, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mActivity:Landroid/app/Activity;
...
.method private launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZZJ)Z
    ...
    iget-object v0, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mActivity:Landroid/app/Activity;
    ...
    iget-object v0, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    .line 136
    :cond_0
    const-class v5, Lcom/cyanogenmod/settings/ConfirmLockPattern$InternalActivity;
    ...
    .line 134
    invoke-direct/range {v0 .. v9}, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Class;ZZJ)Z
    ...
    .local v11, "launched":Z
    :cond_1
    const-class v5, Lcom/cyanogenmod/settings/ConfirmLockPattern;
    ...
    .line 147
    :cond_2
    const-class v5, Lcom/cyanogenmod/settings/ConfirmLockPassword$InternalActivity;
    ...
    .local v11, "launched":Z
    :cond_3
    const-class v5, Lcom/cyanogenmod/settings/ConfirmLockPassword;
...
.method public cmUtils()Lorg/cyanogenmod/internal/util/CmLockPatternUtils;
    ...
    .prologue
    .line 61
    iget-object v0, p0, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->mCmLockPatternUtils:Lorg/cyanogenmod/internal/util/CmLockPatternUtils;
...
.method launchConfirmationActivity(ILjava/lang/CharSequence;)Z
    ...
    .line 72
    invoke-virtual/range {v0 .. v6}, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZ)Z
...
.method public launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;J)Z
    ...
    .line 120
    invoke-direct/range {v0 .. v9}, Lcom/cyanogenmod/settings/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZZJ)Z

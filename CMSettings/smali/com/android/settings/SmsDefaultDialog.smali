.class public final Lcom/cyanogenmod/settings/SmsDefaultDialog;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;
    }
.end annotation
...
.method private buildDialog(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v4}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 92
    :cond_0
    iget-object v2, p0, Lcom/cyanogenmod/settings/SmsDefaultDialog;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;

    .line 93
    .local v2, "p":Lcom/android/internal/app/AlertController$AlertParams;
    const v4, 0x7f0c0819

    invoke-virtual {p0, v4}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->getString(I)Ljava/lang/String;
    ...
    iput-object v4, p0, Lcom/cyanogenmod/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;

    .line 95
    iget-object v4, p0, Lcom/cyanogenmod/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    .line 104
    iget-object v5, p0, Lcom/cyanogenmod/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    invoke-virtual {p0, v5, v4}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->setupAlert()V
    ...
    .end local v1    # "oldSmsComponent":Landroid/content/ComponentName;
    :cond_3
    new-instance v4, Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;

    invoke-direct {v4, p0}, Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;-><init>(Lcom/cyanogenmod/settings/SmsDefaultDialog;)V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    check-cast v0, Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;

    .line 74
    .local v0, "adapter":Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;
    invoke-virtual {v0, p2}, Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;->isSelected(I)Z
    ...
    .line 75
    invoke-virtual {v0, p2}, Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;->getPackageName(I)Ljava/lang/String;
    ...
    .line 78
    invoke-virtual {p0, v3}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->setResult(I)V

    .line 63
    .end local v0    # "adapter":Lcom/cyanogenmod/settings/SmsDefaultDialog$AppListAdapter;
    ...
    .line 66
    :pswitch_1
    iget-object v2, p0, Lcom/cyanogenmod/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 53
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v2}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->setResult(I)V

    .line 57
    invoke-direct {p0, v1}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->buildDialog(Ljava/lang/String;)Z
    ...
    .line 58
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/SmsDefaultDialog;->finish()V

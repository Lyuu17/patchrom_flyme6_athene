.class public Lcom/cyanogenmod/settings/DeviceAdminSettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cyanogenmod/settings/DeviceAdminSettings$ViewHolder;,
        Lcom/cyanogenmod/settings/DeviceAdminSettings$PolicyListAdapter;,
        Lcom/cyanogenmod/settings/DeviceAdminSettings$1;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/cyanogenmod/settings/DeviceAdminSettings;)Landroid/util/SparseArray;
    .locals 1

    iget-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;

    return-object v0
.end method

.method static synthetic -wrap0(Lcom/cyanogenmod/settings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p1, "item"    # Landroid/app/admin/DeviceAdminInfo;

    .prologue
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->isActiveAdmin(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method static synthetic -wrap1(Lcom/cyanogenmod/settings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p1, "item"    # Landroid/app/admin/DeviceAdminInfo;

    .prologue
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->isDeviceOwner(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method static synthetic -wrap2(Lcom/cyanogenmod/settings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p1, "item"    # Landroid/app/admin/DeviceAdminInfo;

    .prologue
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->isProfileOwner(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method static synthetic -wrap3(Lcom/cyanogenmod/settings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)Z
    .locals 1
    .param p1, "item"    # Landroid/app/admin/DeviceAdminInfo;

    .prologue
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->isRemovingAdmin(Landroid/app/admin/DeviceAdminInfo;)Z
...
.method static synthetic -wrap4(Lcom/cyanogenmod/settings/DeviceAdminSettings;Landroid/app/admin/DeviceAdminInfo;)I
    .locals 1
    .param p1, "adminInfo"    # Landroid/app/admin/DeviceAdminInfo;

    .prologue
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->getUserId(Landroid/app/admin/DeviceAdminInfo;)I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;

    .line 72
    new-instance v0, Lcom/cyanogenmod/settings/DeviceAdminSettings$1;

    invoke-direct {v0, p0}, Lcom/cyanogenmod/settings/DeviceAdminSettings$1;-><init>(Lcom/cyanogenmod/settings/DeviceAdminSettings;)V

    iput-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method private addActiveAdminsForProfile(Ljava/util/List;I)V
    ...
    .line 435
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {p0, v9}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->createDeviceAdminInfo(Landroid/content/pm/ResolveInfo;)Landroid/app/admin/DeviceAdminInfo;
    ...
    .line 454
    iget-object v9, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;
...
.method private addDeviceAdminBroadcastReceiversForProfile(Ljava/util/Collection;I)V
    ...
    .line 403
    .local v4, "n":I
    iget-object v8, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;
    ...
    .line 414
    :cond_3
    invoke-direct {p0, v6}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->createDeviceAdminInfo(Landroid/content/pm/ResolveInfo;)Landroid/app/admin/DeviceAdminInfo;
...
.method private isActiveAdmin(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    .prologue
    .line 357
    iget-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
...
.method private isDeviceOwner(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;
...
.method private isProfileOwner(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    .prologue
    .line 352
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;
...
.method private updateAvailableAdminsForProfile(I)V
    ...
    .prologue
    .line 375
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    invoke-direct {p0, v0, p1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->addActiveAdminsForProfile(Ljava/util/List;I)V

    .line 379
    invoke-direct {p0, v0, p1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->addDeviceAdminBroadcastReceiversForProfile(Ljava/util/Collection;I)V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 101
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->getListView()Landroid/widget/ListView;

    move-result-object v0

    const/4 v1, 0x1

    invoke-static {v0, v1}, Lcom/cyanogenmod/settings/Utils;->forceCustomPadding(Landroid/view/View;Z)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mUm:Landroid/os/UserManager;
...
.method public onListItemClick(Landroid/widget/ListView;Landroid/view/View;IJ)V
    ...
    invoke-direct {p0, v2}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->getUserId(Landroid/app/admin/DeviceAdminInfo;)I
    ...
    invoke-direct {p0, v2}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->isProfileOwner(Landroid/app/admin/DeviceAdminInfo;)Z
    ...
    invoke-virtual {p0, v7, v6}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-class v6, Lcom/cyanogenmod/settings/DeviceAdminAdd;
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public onResume()V
    ...
    iput-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;

    .line 112
    iget-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mProfileOwnerComponents:Landroid/util/SparseArray;

    invoke-virtual {v0}, Landroid/util/SparseArray;->clear()V

    .line 116
    iget-object v0, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mUm:Landroid/os/UserManager;
    ...
    :cond_1
    iput-object v4, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mDeviceOwnerPkg:Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->updateList()V
...
.method updateList()V
    ...
    .prologue
    .line 136
    iget-object v4, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mAdminsByProfile:Landroid/util/SparseArray;

    invoke-virtual {v4}, Landroid/util/SparseArray;->clear()V

    .line 138
    iget-object v4, p0, Lcom/cyanogenmod/settings/DeviceAdminSettings;->mUm:Landroid/os/UserManager;
    ...
    invoke-direct {p0, v1}, Lcom/cyanogenmod/settings/DeviceAdminSettings;->updateAvailableAdminsForProfile(I)V
    ...
    new-instance v5, Lcom/cyanogenmod/settings/DeviceAdminSettings$PolicyListAdapter;

    invoke-direct {v5, p0}, Lcom/cyanogenmod/settings/DeviceAdminSettings$PolicyListAdapter;-><init>(Lcom/cyanogenmod/settings/DeviceAdminSettings;)V

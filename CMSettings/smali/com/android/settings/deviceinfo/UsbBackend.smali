.class public Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mIsUnlocked:Z
    ...
    iput-object v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mUserManager:Landroid/os/UserManager;
    ...
    iput-object v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mUsbManager:Landroid/hardware/usb/UsbManager;

    .line 57
    iget-object v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mUserManager:Landroid/os/UserManager;
    ...
    iput-boolean v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mRestricted:Z
    ...
    iput-boolean v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mMidi:Z

    .line 60
    iget-object v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    iput-object v5, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mPort:Landroid/hardware/usb/UsbPort;

    .line 68
    iput-object v4, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mPortStatus:Landroid/hardware/usb/UsbPortStatus;
...
.method private setUsbFunction(I)V
    ...
    .line 111
    :pswitch_0
    iget-object v0, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mUsbManager:Landroid/hardware/usb/UsbManager;
...
.method public getCurrentMode()I
    ...
    .prologue
    .line 75
    iget-object v1, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mPort:Landroid/hardware/usb/UsbPort;

    if-eqz v1, :cond_1

    .line 76
    iget-object v1, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mPortStatus:Landroid/hardware/usb/UsbPortStatus;
    ...
    .local v0, "power":I
    :goto_0
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->getUsbDataMode()I
...
.method public getUsbDataMode()I
    ...
    .line 84
    iget-boolean v0, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mIsUnlocked:Z
...
.method public isModeSupported(I)Z
    ...
    .line 137
    iget-boolean v3, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mRestricted:Z
    ...
    .line 143
    :cond_0
    iget-boolean v3, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mMidi:Z
    ...
    .line 147
    :cond_1
    iget-object v3, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mPort:Landroid/hardware/usb/UsbPort;

    if-eqz v3, :cond_4

    .line 148
    invoke-direct {p0, p1}, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->modeToPower(I)I
    ...
    .line 155
    :cond_2
    iget-object v2, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mPortStatus:Landroid/hardware/usb/UsbPortStatus;
...
.method public setMode(I)V
    ...
    .prologue
    .line 118
    iget-object v2, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mPort:Landroid/hardware/usb/UsbPort;
    ...
    .local v0, "dataRole":I
    :goto_0
    iget-object v2, p0, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    invoke-direct {p0, v2}, Lcom/cyanogenmod/settings/deviceinfo/UsbBackend;->setUsbFunction(I)V

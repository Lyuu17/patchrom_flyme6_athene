.class public Lcom/cyanogenmod/settings/PrivacySettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cyanogenmod/settings/PrivacySettings$PrivacySearchIndexProvider;,
        Lcom/cyanogenmod/settings/PrivacySettings$1;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/cyanogenmod/settings/PrivacySettings;)Landroid/preference/SwitchPreference;
    .locals 1

    iget-object v0, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mAutoRestore:Landroid/preference/SwitchPreference;

    return-object v0
.end method

.method static synthetic -get1(Lcom/cyanogenmod/settings/PrivacySettings;)Landroid/app/backup/IBackupManager;
    .locals 1

    iget-object v0, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mBackupManager:Landroid/app/backup/IBackupManager;
...
.method static synthetic -wrap0(Landroid/content/Context;Ljava/util/Collection;)V
    ...
    .prologue
    invoke-static {p0, p1}, Lcom/cyanogenmod/settings/PrivacySettings;->getNonVisibleKeys(Landroid/content/Context;Ljava/util/Collection;)V
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 186
    new-instance v0, Lcom/cyanogenmod/settings/PrivacySettings$PrivacySearchIndexProvider;

    invoke-direct {v0}, Lcom/cyanogenmod/settings/PrivacySettings$PrivacySearchIndexProvider;-><init>()V

    .line 185
    sput-object v0, Lcom/cyanogenmod/settings/PrivacySettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/cyanogenmod/settings/search/Indexable$SearchIndexProvider;
...
.method public constructor <init>()V
    ...
    .line 115
    new-instance v0, Lcom/cyanogenmod/settings/PrivacySettings$1;

    invoke-direct {v0, p0}, Lcom/cyanogenmod/settings/PrivacySettings$1;-><init>(Lcom/cyanogenmod/settings/PrivacySettings;)V

    iput-object v0, p0, Lcom/cyanogenmod/settings/PrivacySettings;->preferenceChangeListener:Landroid/preference/Preference$OnPreferenceChangeListener;
...
.method private setConfigureSummary(Ljava/lang/String;)V
    ...
    .line 171
    iget-object v0, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mConfigure:Landroid/preference/PreferenceScreen;
...
.method private updateToggles()V
    ...
    .line 140
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/PrivacySettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    :try_start_0
    iget-object v9, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mBackupManager:Landroid/app/backup/IBackupManager;
    ...
    .line 151
    .local v2, "configSummary":Ljava/lang/String;
    iget-object v10, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mBackup:Landroid/preference/PreferenceScreen;
    ...
    :goto_1
    iget-object v9, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mAutoRestore:Landroid/preference/SwitchPreference;
    ...
    .line 161
    iget-object v7, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mAutoRestore:Landroid/preference/SwitchPreference;
    ...
    .line 164
    :goto_3
    iget-object v7, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mConfigure:Landroid/preference/PreferenceScreen;
    ...
    .line 166
    invoke-direct {p0, v2}, Lcom/cyanogenmod/settings/PrivacySettings;->setConfigureSummary(Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mBackup:Landroid/preference/PreferenceScreen;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v5, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mEnabled:Z

    .line 76
    iget-boolean v5, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mEnabled:Z
    ...
    invoke-virtual {p0, v5}, Lcom/cyanogenmod/settings/PrivacySettings;->addPreferencesFromResource(I)V

    .line 81
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/PrivacySettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iput-object v5, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mBackupManager:Landroid/app/backup/IBackupManager;
    ...
    iput-object v5, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mBackup:Landroid/preference/PreferenceScreen;
    ...
    iput-object v5, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mAutoRestore:Landroid/preference/SwitchPreference;

    .line 88
    iget-object v5, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mAutoRestore:Landroid/preference/SwitchPreference;

    iget-object v6, p0, Lcom/cyanogenmod/settings/PrivacySettings;->preferenceChangeListener:Landroid/preference/Preference$OnPreferenceChangeListener;
    ...
    iput-object v5, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mConfigure:Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0}, Lcom/cyanogenmod/settings/PrivacySettings;->getActivity()Landroid/app/Activity;

    move-result-object v5

    invoke-static {v5, v1}, Lcom/cyanogenmod/settings/PrivacySettings;->getNonVisibleKeys(Landroid/content/Context;Ljava/util/Collection;)V
    ...
    :cond_2
    invoke-direct {p0}, Lcom/cyanogenmod/settings/PrivacySettings;->updateToggles()V
...
.method public onResume()V
    ...
    .line 110
    iget-boolean v0, p0, Lcom/cyanogenmod/settings/PrivacySettings;->mEnabled:Z

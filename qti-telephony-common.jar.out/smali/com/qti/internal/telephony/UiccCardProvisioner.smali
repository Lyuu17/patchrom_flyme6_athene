...
.method private broadcastInternalProvisionStatusChanged()V
    .locals 2
    ...
    const-string v1, "com.motorola.intent.action.ACTION_INTERNAL_SIM_PROVISION_STATUS_CHANGED"
...
.method private queryUiccProvisionInfo(I)V
    ...
    invoke-virtual {v2}, Lcom/qti/internal/telephony/UiccCardProvisioner$UiccProvisionStatus;->getCurrentState()I
    ...
    .line 274
    invoke-direct {p0}, Lcom/qti/internal/telephony/UiccCardProvisioner;->broadcastInternalProvisionStatusChanged()V
...
.method public getCurrentUiccCardProvisioningStatus(I)I
    ...
    .prologue
    .line 330
    const-string v1, "getCurrentUiccCardProvisioningStatus"

    invoke-direct {p0, v1}, Lcom/qti/internal/telephony/UiccCardProvisioner;->enforceReadPhoneState(Ljava/lang/String;)V
...
.method public getUiccCardProvisioningUserPreference(I)I
    ...
    .prologue
    .line 342
    const-string v1, "getUiccCardProvisioningUserPreference"
